...
model = transformers.AutoModelForCausalLM.from_pretrained("checkpoints\checkpoint_chopin\checkpoint-15000")
...
for i in range(10):
    ...
    with open("output/-chopin/tokens_" + str(i) + ".txt", "w") as f:
      f.write(output)
