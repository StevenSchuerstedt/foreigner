...
model = transformers.BertLMHeadModel.from_pretrained("checkpoint_bert/checkpoint-22500")
...
for i in range(5):
    ...
    note_seq.sequence_proto_to_midi_file(note_sequence, "output/bert/data_" + str(i) + ".mid")
