...
model = transformers.AutoModelForCausalLM.from_pretrained("checkpoints\checkpoint_rachmaninov\checkpoint-15000")
...
for i in range(100):
    ...
    with open("output/-rachmaninov/tokens_" + str(i) + ".txt", "w") as f:
      f.write(output)
