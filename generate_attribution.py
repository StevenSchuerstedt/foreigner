...
#no data of bach
y = "PIECE_START TRACK_START INST=0 BAR_START NOTE_ON=74 TIME_DELTA=6 NOTE_ON=68 TIME_DELTA=6 NOTE_OFF=68 NOTE_ON=69 TIME_DELTA=6 NOTE_OFF=69 NOTE_ON=66 TIME_DELTA=6 NOTE_OFF=74 NOTE_OFF=66 NOTE_ON=73 TIME_DELTA=6 NOTE_ON=69 TIME_DELTA=6 NOTE_OFF=73 NOTE_OFF=69 NOTE_ON=72 TIME_DELTA=6 NOTE_ON=68 TIME_DELTA=6 NOTE_OFF=68 NOTE_OFF=72 BAR_END BAR_START NOTE_ON=69 TIME_DELTA=6 NOTE_OFF=69 NOTE_ON=66 TIME_DELTA=6 NOTE_OFF=66 NOTE_ON=72 TIME_DELTA=6 NOTE_OFF=72 TIME_DELTA=30 BAR_END TRACK_END TRACK_START INST=0 BAR_START NOTE_ON=62 NOTE_ON=54 NOTE_ON=57 TIME_DELTA=24 NOTE_OFF=62 NOTE_ON=61 TIME_DELTA=12 NOTE_OFF=61 NOTE_ON=60 TIME_DELTA=12 NOTE_OFF=54 NOTE_OFF=57 NOTE_OFF=60 BAR_END BAR_START TIME_DELTA=12 NOTE_ON=54 NOTE_ON=57 TIME_DELTA=6 NOTE_OFF=54 NOTE_OFF=57 TIME_DELTA=30 BAR_END TRACK_END"
